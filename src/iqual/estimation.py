...
class Classifier(BaseEstimator, TransformerMixin):
    ...
    def set_params(self, **kwargs):        
        ...
        self.classifier.set_params(**{k:v for k,v in kwargs.items() if k not in ['model','is_final']})
    ...
    def predict_proba(self, X, **kwargs):
        ...
        if hasattr(self.classifier, "predict_proba"):
            ...
            if hasattr(self.classifier, 'decision_function') or hasattr(self.classifier, '_decision_function'):                          
