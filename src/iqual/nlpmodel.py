...
class NLPModel:
    ...
    def add_feature_scaler(self,name="StandardScaler", **kwargs):
        ...
        """
        self.transformation_steps.append(("FeatureTransformation", FeatureScaler(name=name, **kwargs)))
    ...
    def add_dimensionality_reducer(self, name="PCA", **kwargs):
        ...
        """
        self.transformation_steps.append(("FeatureTransformation", DimensionalityReduction(name=name, **kwargs)))

    def add_feature_transformer(self, name="StandardScaler", transformation="DimensionalityReduction", **kwargs):
        """
        """
        if transformation == "DimensionalityReduction":
            ...
            raise ValueError("Invalid transformation method, please choose from 'DimensionalityReduction' or 'FeatureScaler'")
